...
TaskHub stores data by serializing `JsonAdaptedEmployee` into `json` with the help of an external library — Jackson. Let’s update `JsonAdaptedEmployee` to work with our new `Employee`!
